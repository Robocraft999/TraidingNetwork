...
public class ResourcePointProviderImpl {
    ...
    public static class DefaultImpl implements IResourcePointProvider {
        ...
        public CompoundTag serializeNBT() {
            ...
            TraidingNetwork.LOGGER.debug("ser" + properties.getString("resourcepoints"));
        ...
        public void deserializeNBT(CompoundTag properties) {
            ...
            TraidingNetwork.LOGGER.debug("des" + resourcePoints);
    ...
    public static class Provider implements ICapabilityProvider, INBTSerializable<CompoundTag> {
        public static final ResourceLocation NAME = new ResourceLocation(TraidingNetwork.MODID, "properties");//"providerresourcepoints"
