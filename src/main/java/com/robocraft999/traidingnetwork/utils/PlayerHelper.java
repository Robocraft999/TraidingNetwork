...
import com.robocraft999.traidingnetwork.mixin.accessor.ObjectiveCriteriaAccessor;
...
public class PlayerHelper {
    ...
    public final static ObjectiveCriteria SCOREBOARD_RP = ObjectiveCriteriaAccessor.traidingnetwork$registerCustom(TraidingNetwork.MODID + ":rp_score", true, ObjectiveCriteria.RenderType.INTEGER);
